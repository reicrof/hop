...
constexpr uint64_t LOD_NANOS[] = {30000000, 300000000, 600000000, 3000000000, 6000000000, 30000000000, 70000000000, 600000000000, 50000000000000};
constexpr uint64_t LOD_MIN_SIZE_NANOS[] = {80000, 1200000, 2500000, 3000000, 15000000, 30000000, 200000000, 1000000000, 10000000000};
